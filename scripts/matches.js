// Adds the liked profile's user name to the user's matches array on Cloud FireStore if the liked user likes user back

// stores the UIDs of the profiles liked by user
var likedUid = [];
                            ...
                            db.collection("users").doc(likedUid[index]).onSnapshot(function (snap) {
                                ...
                                if (likedUsersLikes.includes(userName)) {
                                    ...
                                    db.collection("users").doc(likedUserUid).onSnapshot(function (snap) {
                                        ...
                                        // Add the name of the liked user to the user's matches array
